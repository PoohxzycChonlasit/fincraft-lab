...
- **P6_CRAFT_API_9F checkpoint**: "docs: record craft concurrency runtime user id"
...
```text
P6_CRAFT_API_9G_FINAL_RUNTIME_EVIDENCE_CHECK_001 — Read-only post-fix check of finalized Craft API runtime acceptance evidence documentation.
```
