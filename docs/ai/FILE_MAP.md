...
| `prisma/schema.prisma` | Approved 15-model MVP Prisma schema (`moduleFormat = "cjs"`, output to `src/database/generated/prisma`) | created in P2B.1, updated to 15-model MVP in P3 | Add migrations in P3B |
...
```text
fincraft-lab-api/prisma/migrations/     (no migration created yet — planned for P3B)
