...
4. Follow the Stepwise Loop described in `.agents/skills/fincraft-teacher-stepwise-loop/SKILL.md` (and for all frontend tasks, also follow `.agents/skills/fincraft-frontend-engineering/SKILL.md`). For authorized frontend visual tasks, load `.agents/skills/fincraft-design-taste/SKILL.md` after the frontend skill.
