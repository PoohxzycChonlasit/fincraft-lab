export function MotionAccessibilityNote() {
  return (
    <section aria-labelledby="motion-heading" className="grid gap-8 border-y border-(--border-subtle) py-8 md:grid-cols-[0.8fr_1.2fr]">
      <div>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="border-l-2 border-(--color-teal-600) pl-4">
        ...
        <div className="border-l-2 border-(--color-orange-600) pl-4">
