export function SurfaceLadder() {
  return (
    <section aria-labelledby="surface-heading" className="h-full">
      ...
      <div className="surface-flat mt-5 border border-(--border-subtle) p-4 sm:p-6">
        ...
        <div className="mt-4 grid gap-5 lg:grid-cols-[1fr_12rem] lg:items-center">
          <div className="surface-resting border p-5 sm:p-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.12em] text-(--color-teal-700)">
                  Resting plate
                </p>
              ...
              <span
                aria-hidden="true"
                className="size-3 shrink-0 border border-(--border-subtle) bg-(--surface-flat)"
              />
            </div>
