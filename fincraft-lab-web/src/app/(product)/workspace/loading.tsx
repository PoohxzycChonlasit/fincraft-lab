function LoadingBlock({ className }: { className: string }) {
  return <div aria-hidden="true" className={`animate-pulse rounded-2xl bg-[var(--surface-paper)] ${className}`} />;
}
...
export default function WorkspaceLoading() {
  return (
    <div data-document-page="workspace" className="mx-auto max-w-5xl space-y-6" aria-busy="true">
      ...
      <section className="surface-solid space-y-4 rounded-2xl border border-[var(--border-subtle)] p-4 sm:p-6">
