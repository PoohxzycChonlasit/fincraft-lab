...
export const STARTER_ELEMENT_DETAIL_SEED_DATA: StarterElementDetailSeedInput[] = [
  {
    ...
    example: 'A salaried worker receives GBP 2,500 monthly net after income tax and pension contributions.',
  ...
  },
  {
    ...
    example: 'Monthly living expenses totaling GBP 1,800 for utility bills, transportation, subscription services, and daily needs.',
  ...
  },
  {
    ...
    example: 'Setting aside GBP 250 directly into a high-yield savings account on payday before allocating discretionary spending.',
  ...
  },
  {
    ...
    example: 'Taking out a GBP 3,000 personal loan repayable over 12 months with monthly principal and interest charges.',
  ...
  },
  {
    ...
    example: 'A 15% annual percentage rate (APR) credit card charge adds GBP 50 in monthly interest cost on a GBP 4,000 balance.',
    ...
    sources: [
      {
        title: 'Monetary Policy and Key Interest Rates',
        organization: 'ECB',
  ...
  },
  {
    ...
    example: 'An annual inflation rate of 3% increases an annual basket of groceries from GBP 4,000 to GBP 4,120 for the same items.',
  ...
  },
  {
    ...
    example: 'Setting aside GBP 5,400 in a liquid savings account to cover 3 to 6 months of essential living expenses.',
  ...
  },
  {
    ...
    example: 'Budgeting GBP 350 per month for home groceries and essential daily meals.',
  ...
  },
  {
    ...
    example: 'Paying GBP 750 monthly rent for an apartment under a 12-month lease agreement.',
